...
function usePresence(subscribe2 = true) {
  ...
  if (context === null)
    return [true, null];
  const { isPresent, onExitComplete, register: register3 } = context;
...
function useVisualElement(Component, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const isMounted3 = reactExports.useRef(false);
  reactExports.useInsertionEffect(() => {
    if (visualElement && isMounted3.current) {
...
function press(elementOrSelector, onPressStart, options = {}) {
  const [elements, eventOptions, cancelEvents2] = setupGesture(elementOrSelector, options);
...
class ExitAnimationFeature extends Feature {
  ...
  mount() {
    const { register: register3 } = this.node.presenceContext || {};
    if (register3) {
      this.unmount = register3(this.id);
    }
  }
  unmount() {
  }
...
const Navbar = () => {
  const [nav, setNav] = reactExports.useState(false);
  const [shadow, setShadow] = reactExports.useState(false);
  reactExports.useEffect(() => {
    const handleShadow = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: `fixed w-full h-20 z-[100] transition-all duration-300 ${shadow ? "bg-background shadow-xl" : "bg-transparent"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center w-full h-full px-4 2xl:px-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Alok" }),
            " Kumar"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex items-center", children: navLinks.map(({ title, path }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "ml-10 text-sm uppercase hover:text-primary cursor-pointer transition-colors duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: path, smooth: true, duration: 500, spy: true, exact: "true", offset: -80, children: title }) }, path)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center ml-10 space-x-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://github.com/ALOKKUMAR474", target: "_blank", rel: "noreferrer", className: "hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaGithub, { size: 20 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://linkedin.com/in/alok-kumar-901727291", target: "_blank", rel: "noreferrer", className: "hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaLinkedin, { size: 20 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/resume.pdf", target: "_blank", className: "bg-primary hover:bg-blue-600 text-white px-4 py-2 rounded-md font-medium text-sm transition-colors", children: "Resume" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { onClick: handleNav, className: "md:hidden cursor-pointer p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaBars, { size: 25 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: nav ? "md:hidden fixed left-0 top-0 w-full h-screen bg-black/70 z-[101]" : "", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: nav ? "fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-background p-10 ease-in duration-500" : "fixed left-[-100%] top-0 p-10 ease-in duration-500", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { onClick: handleNav, className: "rounded-full shadow-lg shadow-slate-900 p-3 cursor-pointer hover:bg-slate-800 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaTimes, {}) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-slate-700 my-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "w-[85%] md:w-[90%] py-4 text-sm text-slate-400", children: "Let's build something legendary together." }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 flex flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "uppercase", children: navLinks.map(({ title, path }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "py-4 text-sm hover:text-primary transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { onClick: () => setNav(false), to: path, smooth: true, duration: 500, offset: -80, children: title }) }, path)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "uppercase tracking-widest text-primary", children: "Let's Connect" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between my-4 w-full sm:w-[80%]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://github.com/ALOKKUMAR474", target: "_blank", rel: "noreferrer", className: "rounded-full shadow-lg shadow-slate-900 p-3 cursor-pointer hover:scale-105 ease-in duration-300 bg-slate-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaGithub, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://linkedin.com/in/alok-kumar-901727291", target: "_blank", rel: "noreferrer", className: "rounded-full shadow-lg shadow-slate-900 p-3 cursor-pointer hover:scale-105 ease-in duration-300 bg-slate-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaLinkedin, {}) })
          ] })
        ] })
      ] })
    ] }) })
...
const Hero = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "home", className: "w-full h-screen text-center relative overflow-hidden flex items-center justify-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-0 overflow-hidden pointer-events-none", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          className: "absolute -bottom-[10%] -right-[10%] w-[50%] h-[50%] bg-accent-purple/20 blur-[120px] rounded-full"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
          ...
          transition: { duration: 0.5 },
          className: "uppercase text-sm tracking-widest text-slate-400",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.h1,
        {
          ...
          children: [
            "Hi, I'm ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient font-bold", children: "Alok Kumar" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
          ...
          className: "py-2 text-slate-300 max-w-[70%] mx-auto",
          children: "Frontend Developer | React.js Developer"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
          ...
          className: "py-4 text-slate-400 max-w-[70%] m-auto",
          children: "I am a passionate Frontend Developer specializing in React.js and modern JavaScript. I build responsive, scalable, and user-friendly web applications."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          className: "flex items-center justify-between max-w-[330px] m-auto py-4 gap-4",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://github.com/ALOKKUMAR474", target: "_blank", rel: "noreferrer", className: "rounded-full shadow-lg shadow-slate-900 p-4 cursor-pointer hover:scale-110 ease-in duration-300 bg-slate-900 border border-slate-800 hover:border-primary/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaGithub, { size: 20 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://linkedin.com/in/alok-kumar-901727291", target: "_blank", rel: "noreferrer", className: "rounded-full shadow-lg shadow-slate-900 p-4 cursor-pointer hover:scale-110 ease-in duration-300 bg-slate-900 border border-slate-800 hover:border-primary/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaLinkedin, { size: 20 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:alokkumarrajawat47@gmail.com", className: "rounded-full shadow-lg shadow-slate-900 p-4 cursor-pointer hover:scale-110 ease-in duration-300 bg-slate-900 border border-slate-800 hover:border-primary/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaEnvelope, { size: 20 }) })
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "projects", smooth: true, duration: 500, offset: -80, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-primary hover:bg-blue-600 text-white px-8 py-3 rounded-full font-bold transition-all hover:translate-y-[-2px] shadow-lg shadow-primary/20 cursor-pointer", children: "View Projects" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "contact", smooth: true, duration: 500, offset: -80, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "border border-slate-700 hover:border-primary text-slate-200 px-8 py-3 rounded-full font-bold transition-all hover:bg-slate-900 cursor-pointer", children: "Contact Me" }) })
          ]
        }
      )
    ] }) })
...
const About = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "about", className: "w-full md:h-screen p-2 flex items-center py-16 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1240px] m-auto md:grid grid-cols-3 gap-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "uppercase text-xl tracking-widest text-primary font-bold", children: "About" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "py-4", children: "Who I Am" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "py-2 text-slate-400", children: "I am currently pursuing a Bachelor of Computer Applications (BCA) at Chandigarh Group of Colleges (2023–2026). My journey into web development started with a curiosity for how the internet works, which led me to dive deep into Frontend technologies." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "py-2 text-slate-400", children: "I recently completed industrial training in MERN stack development at TCIL-IT Chandigarh. During this period, I gained hands-on experience in building full-stack applications using React, Node.js, Express, and MongoDB. I enjoy the process of turning a complex problem into a simple, beautiful, and intuitive interface." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "py-2 text-slate-400", children: "I'm always looking to learn new technologies and stay up-to-date with the latest industry trends. My goal is to build high-quality software that makes a difference in people's lives." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-6 rounded-xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-primary font-bold mb-2", children: "Education" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-300", children: "BCA – Chandigarh Group of Colleges" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: "2023 – 2026" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-6 rounded-xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-primary font-bold mb-2", children: "Training" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-300", children: "MERN Stack Industrial Training" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: "TCIL-IT Chandigarh" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-6 rounded-xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-primary font-bold mb-2", children: "Location" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-300", children: "India" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: "Based in Chandigarh" })
            ] })
          ] })
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        transition: { duration: 0.5 },
        className: "w-full h-auto m-auto glass-card rounded-2xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300 mt-12 md:mt-0 aspect-square max-w-[400px]",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full h-full bg-slate-800 rounded-xl flex items-center justify-center text-slate-600 overflow-hidden relative group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary/20 to-accent-purple/20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl font-bold opacity-50 z-10", children: "AK" })
        ] })
      }
    )
  ] }) });
...
const Projects = () => {
  const projects = [
    {
      ...
      description: "A MERN stack web application that allows users to browse and purchase books online. Features include 1000+ book listings, fast checkout system, and REST API integration.",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "projects", className: "w-full py-16 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1240px] mx-auto flex flex-col justify-center h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl tracking-widest uppercase text-primary font-bold", children: "Projects" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "py-4", children: "What I've Built" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-8 mt-8", children: projects.map((project, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        transition: { duration: 0.5 },
        whileHover: { y: -5 },
        className: "glass-card rounded-2xl overflow-hidden group border border-slate-800",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[250px] overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-slate-900/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: project.github, target: "_blank", rel: "noreferrer", className: "p-3 bg-white text-slate-900 rounded-full hover:bg-primary hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaGithub, { size: 20 }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: project.demo, target: "_blank", rel: "noreferrer", className: "p-3 bg-white text-slate-900 rounded-full hover:bg-primary hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaExternalLinkAlt, { size: 20 }) })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between items-start mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-white", children: project.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-sm font-medium", children: project.subtitle })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 text-sm mb-6 leading-relaxed", children: project.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: project.tech.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-3 py-1 bg-slate-800 text-primary text-xs rounded-full border border-slate-700 font-medium", children: item }, i)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 pt-6 border-t border-slate-800 flex gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: project.demo, target: "_blank", rel: "noreferrer", className: "flex-1 text-center bg-primary hover:bg-blue-600 text-white py-2 rounded-lg text-sm font-bold transition-colors", children: "Live Demo" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: project.github, target: "_blank", rel: "noreferrer", className: "flex-1 text-center border border-slate-700 hover:border-primary text-slate-300 py-2 rounded-lg text-sm font-bold transition-all", children: "Code" })
            ] })
          ] })
        ]
      },
  ...
  const experiences = [
    {
      ...
      description: [
        "Built full-stack MERN applications as part of industrial training",
        "Integrated REST APIs and worked with MongoDB databases",
        "Learned professional development workflows and best practices",
        "Collaborated on project implementation using modern web technologies"
      ],
      type: "work"
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "experience", className: "w-full py-16 px-6 scroll-mt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1240px] mx-auto flex flex-col justify-center h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl tracking-widest uppercase text-primary font-bold", children: "Experience" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "py-4", children: "My Professional Journey" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col md:grid grid-cols-9 mx-auto p-2 text-slate-200 mt-8", children: experiences.map((exp, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(React$1.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row-reverse md:contents", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          whileInView: { opacity: 1, x: 0 },
          initial: { opacity: 0, x: -50 },
          transition: { duration: 0.5 },
          className: "glass-card col-start-1 col-end-5 p-6 rounded-2xl my-4 ml-auto",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xl mb-1", children: exp.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-primary font-medium mb-3", children: exp.company }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-500 mb-4", children: exp.period }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "list-disc list-inside text-sm text-slate-400 space-y-2", children: exp.description.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: item }, i)) })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-start-5 col-end-6 md:mx-auto relative mr-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-6 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-1 bg-slate-800 pointer-events-none" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 absolute top-1/2 -mt-3 rounded-full bg-primary shadow-lg shadow-primary/30 flex items-center justify-center", children: exp.type === "work" ? /* @__PURE__ */ jsxRuntimeExports.jsx(FaBriefcase, { size: 10, className: "text-white" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FaGraduationCap, { size: 10, className: "text-white" }) })
      ] })
    ] }) }, idx)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl tracking-widest uppercase text-primary font-bold", children: "Certifications" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            whileInView: { opacity: 1, y: 0 },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg mb-2 text-white", children: "Web Design for Beginners" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 text-sm", children: "MindLuster" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            className: "glass-card p-6 rounded-2xl border-l-4 border-l-primary",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg mb-2 text-white", children: "Python Machine Learning for Beginners" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 text-sm", children: "MindLuster" })
            ]
          }
        )
...
const Contact = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "contact", className: "w-full lg:h-screen py-16 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1240px] m-auto px-2 py-16 w-full ", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl tracking-widest uppercase text-primary font-bold", children: "Contact" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "py-4", children: "Get In Touch" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-5 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          transition: { duration: 0.5 },
          className: "col-span-3 lg:col-span-2 w-full h-full glass-card p-4 rounded-2xl",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:p-4 h-full", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "py-2 text-white", children: "Alok Kumar" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary font-medium mb-4", children: "Frontend Developer" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 text-sm leading-relaxed", children: "I am available for freelance or full-time positions. Contact me and let's talk about how I can help you." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "uppercase pt-8 text-primary font-bold tracking-widest text-sm", children: "Connect With Me" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-slate-300 hover:text-primary transition-colors cursor-pointer group", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-slate-900 rounded-lg group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaEnvelope, {}) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "alokkumarrajawat47@gmail.com" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-slate-300 hover:text-primary transition-colors cursor-pointer group", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-slate-900 rounded-lg group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaMapMarkerAlt, {}) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "India" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-start gap-6 py-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://linkedin.com/in/alok-kumar-901727291", target: "_blank", rel: "noreferrer", className: "rounded-full shadow-lg shadow-slate-900 p-4 cursor-pointer hover:scale-110 ease-in duration-300 bg-slate-900 border border-slate-800 hover:border-primary/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaLinkedin, { size: 20 }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://github.com/ALOKKUMAR474", target: "_blank", rel: "noreferrer", className: "rounded-full shadow-lg shadow-slate-900 p-4 cursor-pointer hover:scale-110 ease-in duration-300 bg-slate-900 border border-slate-800 hover:border-primary/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaGithub, { size: 20 }) })
              ] })
            ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          initial: { opacity: 0, x: 30 },
          transition: { duration: 0.5 },
          className: "col-span-3 w-full h-auto glass-card rounded-2xl lg:p-4",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { action: "#", method: "POST", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-4 w-full py-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "uppercase text-xs font-bold py-2 text-slate-400", children: "Name" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    className: "border-2 rounded-lg p-3 flex border-slate-800 bg-slate-900 outline-none focus:border-primary/50 transition-colors text-slate-200",
                    type: "text",
                    name: "name",
                    required: true
                  }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "uppercase text-xs font-bold py-2 text-slate-400", children: "Email" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    className: "border-2 rounded-lg p-3 flex border-slate-800 bg-slate-900 outline-none focus:border-primary/50 transition-colors text-slate-200",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col py-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "uppercase text-xs font-bold py-2 text-slate-400", children: "Subject" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  className: "border-2 rounded-lg p-3 flex border-slate-800 bg-slate-900 outline-none focus:border-primary/50 transition-colors text-slate-200",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col py-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "uppercase text-xs font-bold py-2 text-slate-400", children: "Message" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "textarea",
                {
                  className: "border-2 rounded-lg p-3 border-slate-800 bg-slate-900 outline-none focus:border-primary/50 transition-colors text-slate-200",
                  rows: "6",
                  name: "message",
                  required: true
                }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "w-full p-4 text-white mt-4 bg-primary hover:bg-blue-600 rounded-xl font-bold transition-all shadow-lg shadow-primary/20", children: "Send Message" })
          ] }) })
        }
      )
    ] })
...
const Footer = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "w-full py-12 px-6 border-t border-slate-800 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1240px] mx-auto flex flex-col md:flex-row justify-between items-center gap-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-bold mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Alok" }),
        " Kumar"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 text-sm", children: "Frontend Developer based in India." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://github.com/ALOKKUMAR474", target: "_blank", rel: "noreferrer", className: "text-slate-400 hover:text-primary transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaGithub, { size: 24 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://linkedin.com/in/alok-kumar-901727291", target: "_blank", rel: "noreferrer", className: "text-slate-400 hover:text-primary transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaLinkedin, { size: 24 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:alokkumarrajawat47@gmail.com", className: "text-slate-400 hover:text-primary transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaEnvelope, { size: 24 }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-500 text-xs text-center", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Alok Kumar. All rights reserved."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "flex gap-8 text-sm text-slate-400", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "hover:text-primary cursor-pointer transition-colors", children: "Privacy Policy" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "hover:text-primary cursor-pointer transition-colors", children: "Terms of Service" })
    ] }) })
  ] }) });
};
function App() {
